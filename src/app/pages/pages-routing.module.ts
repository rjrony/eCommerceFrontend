...
import { PrivacyDeclarationComponent } from './privacy-declaration/privacy-declaration.component';
import { DeliveryCollectionComponent } from './delivery-collection/delivery-collection.component';
import {DynamicPageComponent} from "./dynamic-page/dynamic-page.component";
import { ServiceFormComponent } from './account/service-form/service-form.component';
...
const routes: Routes = [
  ...
  { 
    path: 'privacydeclaration', 
    component: PrivacyDeclarationComponent 
  },
  { 
    path: 'deliverycollection', 
    component: DeliveryCollectionComponent 
  },
  { 
    path: 'search', 
